...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['logo']) && $_FILES['logo']['error'] === UPLOAD_ERR_OK) {
        ...
        if (!in_array($_FILES['logo']['type'], $allowedTypes)) {
            ...
            $filename = $schoolName . '_logo_' . time() . '_' . basename($_FILES['logo']['name']);
    ...
    if (empty($errors)) {
        ...
        if ($result['success']) {
            ...
            error_log("School details save error: " . $result['message']);
        }
    }
}
?>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="school_name" value="<?php echo htmlspecialchars($schoolName); ?>" readonly>
                            ...
                            <div class="mb-3">
                                ...
                                <?php if (!empty($schoolDetails['logo_path'])): ?>
                                <div class="mb-2">
                                    <img src="<?php echo '../' . htmlspecialchars($schoolDetails['logo_path']); ?>" alt="School Logo" class="img-thumbnail" style="max-height: 100px;">
                                </div>
                                <?php endif; ?>
